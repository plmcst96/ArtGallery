...
const LINKS = [
  {
    title: "Product",
    items: ["Overview", "Features", "Solutions", "Check-Out"],
  },
  {
    title: "Company",
  ...
  {
    title: "Resource",
    items: ["Blog", "Exhibition", "Events", "Help center"],
  },
]
...
const Footer = () => {
  return (
    <footer className=" w-full" style={{ marginTop: "8em" }}>
      <div className="mx-auto w-full max-w-7xl px-8">
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear}{" "}
            <a href="https://material-tailwind.com/">Women__feels</a>. All
            Rights Reserved.
          </Typography>
          <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
            ...
            <Typography
              ...
              className="opacity-80 transition-opacity hover:opacity-100"
            >
              <Link to="https://github.com/plmcst96">
                <svg
                  className="h-7 w-7"
                  fill="currentColor"
                  viewBox="0 0 24 24"
            ...
            <Typography
              ...
              className="opacity-80 transition-opacity hover:opacity-100"
            >
              <Link to="https://www.linkedin.com/in/cristina-palmisani-fullstack-developer/">
                <svg
